...
import { WonderStoreDriver } from './wonderstore.driver'
...
drivers.set('wonderstore', new WonderStoreDriver())
...
export { MercadoLibreDriver, ShopifyDriver, WooCommerceDriver, FalabellaDriver, JumpsellerDriver, ParisDriver, LiderDriver, EylstoreDriver, WonderStoreDriver }
